...
\node [text width=.2\textwidth] at (5,.05) (block1_u) {};

\node [text width=.2\textwidth] at (5,-.05) (block1_d) {};

\node [terminator, text width=.2\textwidth] at (1,-3) (block2_1) {Strong tonal coarticulation};

\node [text width=.2\textwidth, text height=23] at (1-.05,-3) (block2_1_r) {};

\node [text width=.2\textwidth, text height=23] at (1+.05,-3) (block2_1_l) {};

\node [terminator, text width=.2\textwidth ] at (9,-3) (block2_2) {Weak tonal coarticulaiton};

\node [terminator] at (5,-4-3) (block3) {Phonetic-level perception};

\node [text width=.2\textwidth, text height=17] at (5-.05,-4-3) (block3_l) {};
\node [text width=.2\textwidth, text height=17] at (5+.05,-4-3) (block3_r) {};
...
\node [terminator] at (5,-8-4) (block5) {Phonemic-level perception};

\node [terminator, text width=.2\textwidth] at (5,-10-4) (block6) {Normalization};

\node[draw=none] at (9-.3, -5-3) (text_1) {C};
\node[draw=none] at (1-.3, -5-3) (text_2) {A};
\node[draw=none] at (5-.3, -5-3) (text_3) {B};
...
\path [connector, color={rgb,255: red, 204; green, 0; blue, 0}] (block2_1_r) -- (block3_l);
\path [connector, color={rgb,255: red, 0; green, 128; blue, 255}] (block2_1_l) -- (block3_r);
