...
\node [text width=.2\textwidth] at (5,.07) (block1_u) {};

\node [text width=.2\textwidth] at (5,-.07) (block1_d) {};

\node [terminator, text width=.2\textwidth] at (1,-1) (block2_1) {Strong tonal coarticulation};

\node [text width=.2\textwidth, text height=23] at (1-.07,-1) (block2_1_r) {};

\node [text width=.2\textwidth, text height=23] at (1+.07,-1) (block2_1_l) {};

\node [terminator, text width=.2\textwidth ] at (9,-1) (block2_2) {Weak tonal coarticulaiton};

\node [terminator] at (5,-4-3) (block3) {Phonetic-level perception};

\node [text width=.2\textwidth, text height=17] at (5-.1,-4-3.013) (block3_l) {};
\node [text width=.2\textwidth, text height=17] at (5+.1,-4-3.013) (block3_r) {};

\node[draw=none] at (-2,-1+.2) {\textbf{Speaker}};

\node[draw=none] at (-2, -4) (text_4) {\textbf{Acoustics}};

\draw [gray, dotted, thick] (-3, -4+2)-- (11, -4+2);
\draw [gray, dotted, thick] (-3, -4-2)-- (11, -4-2);


\node[draw=none] at (-2, -10-.2) {\textbf{Listener}};

\node [terminator, text width=.2\textwidth] at (1,-6-3.5) (block4_1) {Loose tonal boundaries};
\node [terminator, text width=.2\textwidth] at (5,-6-3.5) (block4_2) {Strict tonal boundaries};

\node [terminator, text width=.2\textwidth] at (5,-8-4) (block5) {Phonemic-level perception};

\node [text width=.2\textwidth] at (5,-8-4+.07) (block5_u) {};
\node [text width=.2\textwidth] at (5,-8-4-.07) (block5_d) {};

\node [terminator, text width=.2\textwidth] at (1,-10-4) (block6) {Normalization};

\path [connector, color={rgb,255: red, 204; green, 0; blue, 0}] (block1_u) -| (block2_1_r);

\path [connector, color={rgb,255: red, 0; green, 128; blue, 255}] (block1_d) -| (block2_1_l);

\path [connector, color={rgb,255: red, 76; green, 153; blue, 0}] (block1) -| (block2_2);

\path [connector, color={rgb,255: red, 204; green, 0; blue, 0}] (block2_1_r) -- (block3_l)node [midway, below, sloped] (TextNode) {\textcolor{cornellred}{Type I language}};
\path [connector, color={rgb,255: red, 0; green, 128; blue, 255}] (block2_1_l) -- (block3_r) node [midway, above, sloped] (TextNode) {\textcolor{coolblack}{Type II language}};

\path [connector, color={rgb,255: red, 76; green, 153; blue, 0}] (block2_2) -- (block3) node [midway, above, sloped] (TextNode) {\textcolor{darkgreen}{Type III language}};
...
\path [connector, color={rgb,255: red, 76; green, 153; blue, 0}] (block3.east) -- (9, -4-3)|-(block5);


\path [connector, color={rgb,255: red, 204; green, 0; blue, 0}] (block4_1) |- (block5_u);
\path [connector, color={rgb,255: red, 0; green, 128; blue, 255}] (block4_2) -- (block5);

\path [connector, color={rgb,255: red, 204; green, 0; blue, 0}] (block5_d) -| (block6);
