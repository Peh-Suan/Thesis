...
GAMM fitted first derivatives of the acceptance rates are shown in Figure \ref{Figure:E3GAMM}. It is seen that the falling tone acceptance rates had higher maximum of first derivatives in Taiwan Southern Min than in Taiwan Mandarin, while it was the opposite for the low tone.
As suggested in Section \ref{section:E3 Analyses}, the first derivates of the acceptance rates were taken as how strict the tone boundary of the target tone was in the language.
\begin{figure}[hbt!]
\centering
\begin{subfigure}[b]{.45\textwidth}
\centering
...
\label{Figure:E3GAMM}
\end{figure}
The results suggest that the boundary was stricter in Taiwan Southern Min for the falling tone, while for the low tone, it was the opposite. Nevertheless, we shall argue in section \ref{section:Tone boundaries and perception of tonal coarticulation} that such absence of a stricter boundary for the low tone in Taiwan Southern Min was likely due to tone sandhi rules, and that tone boundaries in general shall be deemed as stricter in Taiwan Southern Min than in Taiwan Mandarin.

As can be seen in Figure \ref{Figure:E3GAMM_bilingual}, again, the linguistic difference was seen within the bilingual subjects.
