...
\begin{figure}[hbt!]
\centering
\includegraphics[scale=.45, trim={0 .5cm 0 0}]{Figures/E1/Carryover_lang_seperated.png}
...
\begin{figure}[hbt!]
\centering
\includegraphics[scale=.45, trim={0 .5cm 0 0}]{Figures/E1/Anticipatory_lang_seperated.png}
\caption{Fitted LMM model of tone onsets and offsets in carry-over positions (left: Taiwan Mandarin; right: Taiwan Southern Min).}
